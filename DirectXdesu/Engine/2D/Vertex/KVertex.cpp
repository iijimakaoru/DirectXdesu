...
#pragma region インデックス
	...
	result = static_cast<HREFTYPE>(indexBuff->Map(0, nullptr, (void**)&indexMap));
	// 全インデックスに対して
...
const ID3D12Resource* KVertex::GetIndexBuff() const
{
	return indexBuff.Get();
}

const D3D12_VERTEX_BUFFER_VIEW& KVertex::GetVertBuffView() const
{
	return vbView;
}
