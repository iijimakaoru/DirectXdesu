...
public:
	...
	void SetPipline(KGPlin* pipeline_) { FbxObject3D::pipeline = pipeline_; }

	/// <summary>
	/// モデルセッター
	/// </summary>
	/// <param name="model_"></param>
	void SetModel(FbxModel* model_) { model = model_; }

	/// <summary>
	/// ポジションセッター
	/// </summary>
	/// <param name="pos_"></param>
	void SetPosition(KMyMath::Vector3 pos_) { position = pos_; }

	/// <summary>
	/// ポジションゲッター
	/// </summary>
	/// <returns></returns>
	KMyMath::Vector3 GetPosition() { return position; }
