...
void ParticlePool::Create(ID3D12GraphicsCommandList* cmdList, ID3D12DescriptorHeap* uavHeap, uint32_t particleMax)
{
	...
	Translation(cmdList, D3D12_RESOURCE_STATE_UNORDERED_ACCESS);
