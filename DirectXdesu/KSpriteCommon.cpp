...
SpriteInfo SpriteCommon::SpriteCreate(UINT texNumber, const SpriteCommond& spriteCommon, Vector2 anchorpoint, bool isFlipX, bool isFlipY)
{
	HRESULT result = S_FALSE;
	// 新しいスプライトを作る
	SpriteInfo sprite{};
...
void SpriteCommon::SpriteDraw(const SpriteInfo& sprite, ID3D12GraphicsCommandList* cmdList,
	const SpriteCommond& spriteCommon)
{
	// 非表示フラグ
