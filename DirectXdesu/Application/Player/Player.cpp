...
void Player::Init(
	...
	// HPゲージテクスチャ読み込み
	hpbarTex = TextureManager::Load("PlayerHPBar2", ".png");
	...
	// ダメージエフェクトテクスチャ読み込み
	damageTex = TextureManager::Load("damage", ".png");
	...
	operationTex = TextureManager::Load("setumei", ".png");
	operationPos = {
	...
	bomIconTex = TextureManager::Load("BomIcon", ".png");
